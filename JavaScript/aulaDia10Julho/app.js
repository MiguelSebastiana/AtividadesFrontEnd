...
/*
    ...
    é o seguinte: mesmo quando essa função esta em qualquer lugar dentro do codigo , o JS ele trabalha
    no seu "SUBMUNDO" ou seja em aguas nunca antes navegadas e com isso fara o IÇAMENTO (hoisting) dessa 
    function declaration para o topo fazendo com que a mesma seja executada normalmente (sem apresentar
    nenhum erro)
*/ 
...
// Primeira alteração: Passarmos a turnOffGateSwutch() para cima e vamos deixa-la posicionada no meio do nosso arquivo app.js
// segunda alteração: Desceremos toda a declaração da função turnOffGateSwitch()
...
/* No exemplo do canva o guindaste fez o içamento (ou seja: o Hoisting) para o topo do arquivo, a declaração da Function 
   Declaration. Voces viram que ela apareceu ali no topo "Meio apagada" e a function declaration permaneceu ali embaixo "iluminada".
   É isso que acontece quando ocorre o hoisting em uma function declaration.

   A Function declaration permanece intacta no local onde ela esta, vem um guindaste fastaminha e iça (hoisting) para o top do arquivo sem que possamos
   o que esta acontecendo
*/

// Hoisting so funciona para function declaration e nao para uma function expression
