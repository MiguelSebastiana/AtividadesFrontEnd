...
/* 
    ...
    console.log(52 / "acho que não vai dar certo") //tentar dividir um numero por uma string

    console.log("acho que não vai dar certo tambem" / ) // tentar dividir uma string por um numero
*/