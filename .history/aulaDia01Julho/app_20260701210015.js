...
/*
    ...
    // Função é um pedacinho do codigo que executa uma determinada ação especifica - Função soma
    // Método: É uma função que esta vinculada a um objeto ou tipo de dado em especifico ou particular

    //Podemos falar que uma String possui diversos metodos ou seja: Varias funções que podem executar uma ação especifica

    //Por exemplo (um metodo de String): toUpperCase - para que todos os caracteres de uma String fiquem o maiusculo 
    ...
    console(AnimalsNames.toUpperCase);
