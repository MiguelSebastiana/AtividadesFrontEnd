...
const factoryInfoTemplate = `
    ...
    */
    ...
    // console.log(nothingHere + 21);
    // console.log(`Tem algum valor ai?${nothingHere}`);

    /*ARRAYS*/

    /* Usamos o array para guardamos uma lista de valores que usualmente tem uma relação entre si. 
       Podemos guardar uma lista que possui numeros ou uma lista que possui strings. Exemplo: Um array
       de numeros que possui os numeros dos meses do ano) e um Array de Strings (possui os nomes dos meses do ano).
    */

    // const worldCupYears = [2010, 2014, 2018, 2022, 2026];

    // console.log(worldCupYears[1]);
    
    // O index começa do zero, pois ele é zerobased.

    // let WorldCupChampions = ["Spain", "Germany", "France", "Argentine", "Hexa"];

    // const worldCupYears = [2010, 2014, 2018, 2022, 2026];

    // const mixWorldCup = [2014, "Germany", 2026, "Hexa"];

    // console.log(mixWorldCup);

    /* ARRAY É PUSH (Metodo Push) */

    /* Método PUSH: ele vai incluir novos elementos no final do ARRAY e retornara o seu comprimento (length) */

    // let worldCupChampions = ["Spain", "Germany", "France", "Argentine", "Hexa"];

    // // incluir dentro do array worldCupChampions dois novos campeões mundiais.

    // let moreTwoWorldCupChampions = worldCupChampions.push("Italy", "England");

    // console.log(worldCupChampions); //Ele pegou as 5 seleções que ele ja tinha e acrescentou +2.


    /* Outro metodo de Array que é o Metodo POP*/

    //Ele remove o ultimo elemento do Array e vai retornar no console do navegador esse elemento.
    ...
    // Um dado lógico que pode representar um estado verdadeiro e um estado falso.
    // Retorna um estado verdadeiro e um estado falso
    // Um dado lógico que retorna um estado verdadeiro e um estado falso.
