...
const factoryInfoTemplate = `
    ...
    /* Normalmente quando não precisamos inserir variaveis na String ou fazemos uma quebra de linha que não tem muito sentido usar Template String. E se durante a criação da String percebe */
