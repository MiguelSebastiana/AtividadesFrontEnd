...
/* Ele possibilita inserirmos as noass variaveis dentro da String sem ter que fechar a string, declarar um +, abrir outr String, declarar outro +, fechar string... e etc