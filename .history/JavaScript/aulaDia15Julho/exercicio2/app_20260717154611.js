...
console.log("Primeiro produto" + carrinhoDeCompras[0].produto.nome  + "|" + carrinhoDeCompras[0].produto.preco + "|" + carrinhoDeCompras[0].produto.quantidade);

console.log("Segundo produto" + carrinhoDeCompras[1].produto.nome  + "|" + carrinhoDeCompras[0].produto.preco + "|" + carrinhoDeCompras[0].produto.quantidade);
