...
console.log`Raiz quadrada de 64 é:"calcularRaizQuadrada(9);
...
console.log("Numero aleatorio entre 10 e 100: ", gerarNumeroAleatorio(10, 100));
...
function criarMatriz(linhas, colunas){
    ...
    for (let i = 0; i < linhas; i++){
        ...
        for(let j = 0; j < colunas; j++){
            linhas.push(Math.floor(Math.random() * 100) + 1);
        }
        matriz.push(linha);
    }
    return matriz;
