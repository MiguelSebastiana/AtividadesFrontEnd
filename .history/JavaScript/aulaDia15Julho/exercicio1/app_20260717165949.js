...
console.log("Acessando o segundo elemento: ", frutas[1]);

frutas.push("Morango");
console.log("Adicionando morango: ", frutas);

frutas.shift();
console.log("Removendo o primeiro elemento: ", frutas);

let numerosEx12 = [10, 20, 30];
numerosEx12.push(40);
console.log("NumerosEx12 com push: ", numerosEx12);

numerosEx12.pop();
console.log("NumerosEx12 com pop: ", numerosEx12);

numerosEx12.unshift(5);
console.log("Numeros com unshift: ", numerosEx12);

numerosEx12.shift();
console.log("NumerosEx12 com shift: ", numerosEx12);

let frutas2 = ["Manga", "Abacaxi", "Melancia"];
let todasFrutas = frutas.concat(frutas2);
console.log("Uniao de arrays todasFrutas", todasFrutas);

console.log("Dois primeiros elementos de todasFrutas: ", todasFrutas.slice(0, 2));

todasFrutas.splice(1, 1);
console.log("Após remover o segundo elemento", todasFrutas);

console.log("Indice da fruta 'banana':", todasFrutas.slice(0,2));

let frutasComM = todasFrutas.filter(fruta => fruta.toLowerCase().startsWith("m"));
console.log("Frutas que começam com 'm':", frutasComM);

let dobroNumeros = numerosEx12.map(num => num * 2);
console.log("O dobro de numerosEx12: ", dobroNumeros);

todasFrutas.forEach(fruta => console.log(`Fruta por forEach: ${fruta}`));
// ------------------- 13 ------------------
